        ...
        <div class="right-content">
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <a href="../backoff/eventacc.php" class="dropdown-link">View Events</a>
                </div>
            </div>
   ...
   <div class="product-detail-container">
        ...
        <div class="product-info">
            ...
            <p class="product-price">
                <?= htmlspecialchars(number_format($product['product_price'], 2)) . " Millimes per KG"; ?>
            </p>
            ...
            <form action="addtocart.php" method="POST">
                ...
                <input type="number" id="quantity" name="quantity" min="1" max="<?= htmlspecialchars($product['quantite']); ?>" value="1">
...
<script>
    ...
    stars.forEach(star => {
        star.addEventListener('click', function() {
            ...
            document.getElementById('ratingg').value = value;
            stars.forEach(s => {
